...
public class InputHandler9 : MonoBehaviour
{
    #region Variables
    ...
    public int numberTownsVisited9 = 0;
    public Button finishButton;
    public static int numberTownsMissed9 = 78;
    public static int numberNullPathways9 = 0;
    public static int totalScore9 = 0;
    public static int nonAlternating = 0;
    private String previousColour = " ";
    private String previousColour2 = " ";
    private int startGreen = 1;
    private int finishGreen = 1;
    public static int nonGreen = 2;
    public static int totalBlueMissed = 10;
    public static int total50 = 0;
    ...
    void Start()
    {
        ...
        points = new Point[78];
        numberTownsVisited9 = 0;
        numberTownsMissed9 = 78;
        numberNullPathways9 = 0;
        ...
        else
        {
            if (rayHit.collider != null && rayHit.collider.gameObject.tag.Contains("Town"))
            {
                if (numberTownsMissed9 == 78)
                {
                    ...
                    numberTownsMissed9 -= 2;
                }
                else
                {
                    numberTownsMissed9 -= 1;
                }
                ...
                if (firstObject.tag == "TownBlue")
                {
                    if (!blueTownsVisited.Contains(firstObject.transform.position))
                    {
                        Debug.Log("Blue");
                        totalBlueMissed--;
                ...
                if (secondObject.tag == "TownBlue")
                {
                    if (!blueTownsVisited.Contains(secondObject.transform.position))
                    {
                        Debug.Log("Blue");
                        totalBlueMissed--;
    ...
    public void FinishBtnClick2()
    {
        ...
        if (pathwaysScenario1.Count > 1)
        {
            ...
            numberNullPathways9 = numberPathwaysMissed;
            Debug.Log("Number of Invalid Pathways: " + numberNullPathways9);
        }
        else
        {
        ...
        Debug.Log("Number of missed towns: " + numberTownsMissed9);

        // Calculate Score
        score = score - totalBlueMissed * 50 - nonGreen * 50;
        totalScore9 = Convert.ToInt32(score);
        if(totalScore9 < 0) { totalScore9 = 0; }
    ...
    public void checkInvalidPathways()
    {
        ...
        if (pathwaysScenario1.Count >= 1)
        {
            ...
            numberNullPathways9 = numberPathwaysMissed7;
            Debug.Log("Number of Invalid Pathways: " + numberNullPathways9);
        }
    }
