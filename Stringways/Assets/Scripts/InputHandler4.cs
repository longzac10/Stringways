...
public class InputHandler4 : MonoBehaviour
{
    ...
    public static double limeStringRemaining4;
    public static double pinkStringRemaining4 = 900.0f;
    ...
    private void OnClick()
    {
        ...
        else
        {
            if (rayHit.collider != null && rayHit.collider.gameObject.tag.Contains("Town"))
            {
                ...
                {
                    pinkStringRemaining4 -= distance;
                    pinkMessageText.SetText("Pink string remaining: " + "\n" + pinkStringRemaining4.ToString("0.00") + "cm");
                }
