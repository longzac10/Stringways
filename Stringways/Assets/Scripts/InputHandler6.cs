...
public class InputHandler6 : MonoBehaviour
{
    #region Variables
    ...
    public static double limeStringRemaining6;
    public static double pinkStringRemaining6;
    ...
    public static int numberTownsMissed6 = 78;
    //public static int numberNullPathways5 = 0;
    public static int totalScore6 = 0;
    ...
    public static int numberIncorrectColourMatch;
    ...
    private void OnClick()
    {
        ...
        {        
            ...
            {
                if (numberTownsMissed6 == 78)
                {
                    
                    numberTownsMissed6 -= 2;
                }
                else
                {
                    
                    numberTownsMissed6 -= 1;
                } 
                ...
                if (firstObject.tag == "TownRed" && currentStringColour.Equals("lime") && !redTownsVisited.Contains(firstObject.transform.position))
                {
                    Debug.Log("Unmatching Red");
                    numberIncorrectColourMatch++;
                    redTownsVisited.Add(firstObject.transform.position);
                }
                else if (firstObject.tag == "TownBlue" && currentStringColour.Equals("pink") && !blueTownsVisited.Contains(firstObject.transform.position))
                {
                    Debug.Log("Unmatching Blue");
                    numberIncorrectColourMatch++;
                    blueTownsVisited.Add(firstObject.transform.position);
                }

                if (secondObject.tag == "TownRed" && currentStringColour.Equals("lime") && !redTownsVisited.Contains(secondObject.transform.position))
                {
                    Debug.Log("Unmatching Red2");
                    numberIncorrectColourMatch++;
                    redTownsVisited.Add(secondObject.transform.position);
                }
                else if (secondObject.tag == "TownBlue" && currentStringColour.Equals("pink") && !blueTownsVisited.Contains(secondObject.transform.position))
                {
                    Debug.Log("Unmatching Blue2");
                    numberIncorrectColourMatch++;
                ...
                if (currentStringColour.Equals("lime"))
                {
                    limeStringRemaining6 -= distance;
                    limeMessageText.SetText("Lime string remaining: " + "\n" + limeStringRemaining6.ToString("0.00") + "cm");
                }
                else
                {
                    pinkStringRemaining6 -= distance;
                    pinkMessageText.SetText("Pink string remaining: " + "\n" + pinkStringRemaining6.ToString("0.00") + "cm");
                }
